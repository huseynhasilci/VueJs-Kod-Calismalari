<template>
  <aside class="bg-gray-700 w-[300px] h-screen">
    ...
    <div v-for="invoice in invoiceList" :key="invoice.id" class="odd:bg-gray-600 flex justify-between items-center p-2">
      ...
      <span>
        ...
        <button @click="invoiceDetails(invoice)" class="purple-button">
...
defineProps({invoiceList: Array, invoiceDetails: Function})
